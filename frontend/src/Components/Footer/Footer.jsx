	...
	<Container>
		...
		<Column>
			...
			<div className="social">
				...
				<img src={require("../../Images/facebook-logo.png")}  alt="logo-cryptoview" height={30} width={30} />
				</i>
				</FooterLink>
				<FooterLink href="#">
				<i className="fab fa-instagram">
				<img src={require("../../Images/instagram-social.png")}  alt="logo-cryptoview" height={32} width={32} />
				</i>
				</FooterLink>
			</div>
		</Column>
